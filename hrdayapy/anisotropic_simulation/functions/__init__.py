"""
anisotropic_simulation/functions/__init__.py
===============================================
Public API for the anisotropic_simulation sub-package. Everything except
the solver entry point itself is copied unmodified from
simulation/functions/ -- see purkinje_myocardium_anisotropic_solver.py's
module docstring for exactly what differs and why.
"""
from .purkinje_myocardium_anisotropic_solver import purkinje_myocardium_anisotropic_solver
...
__all__ = [
    "purkinje_myocardium_anisotropic_solver",
    "animate_coupled",
